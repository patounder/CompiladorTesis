...
public abstract class DebuggingCharScanner extends CharScanner implements
        DebuggingParser {
    ...
    public void match(String s) throws MismatchedCharException,
        ...
        try {
            ...
            if (inputState.guessing == 0)
                parserEventSupport.fireMismatch(la_s.toString(), s,
                        inputState.guessing);
            throw e;
        }
    ...
    public void matchNot(char c) throws MismatchedCharException,
        ...
        try {
            ...
            if (inputState.guessing == 0)
                parserEventSupport
                        .fireMismatchNot(la_1, c, inputState.guessing);
            throw e;
        }
    ...
    public void matchRange(char c1, char c2) throws MismatchedCharException,
        ...
        try {
            ...
            parserEventSupport.fireMatch(la_1, "" + c1 + c2,
                    inputState.guessing);
        } catch (MismatchedCharException e) {
            if (inputState.guessing == 0)
                parserEventSupport.fireMismatch(la_1, "" + c1 + c2,
                        inputState.guessing);
            throw e;
        }
