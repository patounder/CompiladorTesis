 ...
 *
 * $Id: GrammarAtom.java,v 1.1 2007-10-19 15:55:01 soto-r Exp $
 */

/**
 * A GrammarAtom is either a token ref, a character ref, or string. The analysis
 * doesn't care.
 */
abstract class GrammarAtom extends AlternativeElement {
    ...
    public void setOption(Token option, Token value) {
        if (option.getText().equals("AST")) {
            ...
            grammar.antlrTool.error("Invalid element option:"
