...
public class ANTLRLexer extends antlr.CharScanner implements ANTLRTokenTypes,
    ...
    public static int escapeCharValue(String cs) {
        ...
        case '3':
            if (cs.length() > 5 && Character.isDigit(cs.charAt(4))) {
                return (cs.charAt(2) - '0') * 8 * 8 + (cs.charAt(3) - '0') * 8
                        + (cs.charAt(4) - '0');
            }
    ...
    public ANTLRLexer(LexerSharedInputState state) {
        ...
        literals.put(new ANTLRHashString("charVocabulary", this), new Integer(
                18));
    ...
    public final void mCARET(boolean _createToken) throws RecognitionException,
            CharStreamException, TokenStreamException {
        int _ttype;
        Token _token = null;
        int _begin = text.length();
    ...
    public final void mRANGE(boolean _createToken) throws RecognitionException,
            CharStreamException, TokenStreamException {
        int _ttype;
        Token _token = null;
        int _begin = text.length();
    ...
    public final void mACTION(boolean _createToken)
        ...
        CommonToken t = new CommonToken(_ttype, new String(text.getBuffer(),
