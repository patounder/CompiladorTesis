 ...
 *
 * $Id: LLkParser.java,v 1.1 2007-10-19 15:55:00 soto-r Exp $
 */
...
public class LLkParser extends Parser {
     ...
     * For example, calling consume() 3 times when k=2, means that the first
     * token consumed will be overwritten with the 3rd.
     */
    ...
    public int LA(int i) throws TokenStreamException {
        // System.out.println("entro en LA ");
