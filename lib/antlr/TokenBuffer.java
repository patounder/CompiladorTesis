 ...
 *
 * $Id: TokenBuffer.java,v 1.1 2007-10-19 15:55:00 soto-r Exp $
 */
...
public class TokenBuffer {
    ...
    public final Token[] LCOLA() throws TokenStreamException {
        // fill(i);
        return queue.buffer;
    }
    ...
    public final int mark() {
        ...
        // System.out.println("LA("+i+")=="+LT(i).getText()); } } catch
        // (ScannerException e) {}
        nMarkers++;
        return markerOffset;
    }
