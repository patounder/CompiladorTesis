...
public class DefaultJavaCodeGeneratorPrintWriterManager implements
    ...
    public PrintWriter setupOutput(Tool tool, Grammar grammar, String fileName)
            throws IOException {
        this.tool = tool;
        ...
        smapOutput = new PrintWriterWithSMAP(tool.openOutputFile(fileName
                + ".java"));
