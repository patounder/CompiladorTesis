 ...
 *
 * $Id: DiagnosticCodeGenerator.java,v 1.1 2007-10-19 15:54:58 soto-r Exp $
 */
...
public class DiagnosticCodeGenerator extends CodeGenerator {
    ...
    protected void genHeader() {
        println("ANTLR-generated file resulting from grammar "
    ...
    public void genRule(RuleSymbol s) {
        ...
        if (unlabeledUserSpec != null) {
            ...
            for (int i = 0; i < unlabeledUserSpec.handlers.size(); i++) {
                ...
                ExceptionHandler handler = (ExceptionHandler) unlabeledUserSpec.handlers
                        .elementAt(i);
    ...
    public String getASTCreateString(Vector v) {
        return "***Create an AST from a vector here***"
