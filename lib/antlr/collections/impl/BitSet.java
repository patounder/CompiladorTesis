 ...
 *
 * $Id: BitSet.java,v 1.1 2007-10-19 15:55:07 soto-r Exp $
 */

import antlr.CharFormatter;

/**
 * A BitSet to replace java.util.BitSet. Primary differences are that most set
 * operators return new sets as opposed to oring and anding "in place". Further,
 * a number of operations were added. I cannot contain a BitSet because there is
 * no way to access the internal bits (which I need for speed) and, because it
 * is final, I cannot subclass to add functionality. Consider defining set
 * degree. Without access to the bits, I must call a method n times to test the
 * ith bit...ack!
 * 
 ...
 * @author Terence Parr
 * @author <br>
 *         <a href="mailto:pete@yamuna.demon.co.uk">Pete Wells</a>
 */
public class BitSet implements Cloneable {
     ...
     * 
     * @param elems
     *            The array of elements representing the set, usually from Bit
     *            Set.toArray().
    ...
    public static Vector getRanges(int[] elems) {
        ...
        for (int i = 0; i < elems.length - 2; i++) {
            ...
            if (lastInRange - i > 2) {
                ranges
                        .appendElement(new IntRange(elems[i],
                                elems[lastInRange]));
            }
        }
        return ranges;
    ...
    /**
     * Subtract the elements of 'a' from 'this' in-place. Basically, just turn
     * off all bits of 'this' that are in 'a'.
     */
    ...
    /**
     * Create a string representation where instead of integer elements, the ith
     * element of vocabulary is displayed instead. Vocabulary is a Vector of
     * Strings.
     * 
     * @separator The string to put in between elements
     * @return A commma-separated list of character constants.
    ...
    /**
     * Dump a comma-separated list of the words making up the bit set. Split
     * each 64 bit number into two more manageable 32 bit numbers. This
     * generates a comma-separated list of C++-like unsigned long constants.
     */
    ...
    /**
     * Dump a comma-separated list of the words making up the bit set. This
     * generates a comma-separated list of Java-like long int constants.
     */
