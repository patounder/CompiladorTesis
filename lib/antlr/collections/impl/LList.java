 ...
 *
 * $Id: LList.java,v 1.1 2007-10-19 15:55:07 soto-r Exp $
 */
...
/**
 * A Linked List Implementation (not thread-safe for simplicity) (adds to the
 * tail) (has an enumeration)
 */
public class LList implements List, Stack {
     ...
     * @return the object at index i NoSuchElementException is thrown if i out
     *         of range
     */
