 ...
 */
public class ANTLRTokdefParser extends antlr.LLkParser implements
    ...
    public final void line(ImportVocabTokenManager tm)
        ...
        try { // for error handling
            ...
            if (s != null) {
                ...
                // if label, then label the string and map label to token symbol
                // also
                if (t != null) {
                    StringLiteralSymbol sl = (StringLiteralSymbol) tm
                            .getTokenSymbol(s.getText());
    ...
    public static final String[] _tokenNames = { "<0>", "EOF", "<2>",
            "NULL_TREE_LOOKAHEAD", "ID", "STRING", "ASSIGN", "LPAREN",
            "RPAREN", "INT", "WS", "SL_COMMENT", "ML_COMMENT", "ESC", "DIGIT",
            "XDIGIT" };
