 ...
 *
 * $Id: RecognitionException.java,v 1.1 2007-10-19 15:54:58 soto-r Exp $
 */
...
public class RecognitionException extends ANTLRException {
     ...
     *             {@see #RecognitionException(char, String, int, int) }
     */
    ...
    public String toString() {
        return FileLineFormatter.getFormatter().getFormatString(fileName, line,
                column)
                + getMessage();
    }
}
