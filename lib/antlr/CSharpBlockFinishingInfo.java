 ...
 *
 * $Id: CSharpBlockFinishingInfo.java,v 1.1 2007-10-19 15:54:58 soto-r Exp $
 */
...
class CSharpBlockFinishingInfo {
     ...
     * the else or default clause, don't generate an error clause in this case.
     */
    ...
    public CSharpBlockFinishingInfo(String ps, boolean genS,
            boolean generatedAnIf, boolean n) {
        postscript = ps;
