 ...
 *
 * $Id: ASTIterator.java,v 1.1 2007-10-19 15:54:57 soto-r Exp $
 */
...
public class ASTIterator {
    ...
    public boolean isSubtree(AST t, AST sub) {
        ...
        for (sibling = t; sibling != null && sub != null; sibling = sibling
    ...
    /**
     * Find the next subtree with structure and token types equal to those of
     * 'template'.
     */
        ...
        for (; cursor != null; cursor = cursor.getNextSibling()) {
            ...
            if (cursor.getType() == template.getType()) {
                ...
                if (cursor.getFirstChild() != null) {
                    if (isSubtree(cursor.getFirstChild(), template
                            .getFirstChild())) {
                        return cursor;
                    }
                }
