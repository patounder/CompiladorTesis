...
public class Preprocessor extends antlr.LLkParser implements
     ...
     *             if a tool has already been registered
     * @since 2.7.2
     */
    ...
    public void reportError(RecognitionException e) {
        if (getTool() != null) {
            getTool().error(e.getErrorMessage(), e.getFilename(), e.getLine(),
                    e.getColumn());
        } else {
            super.reportError(e);
        }
            ...
            match(OPTIONS_START);
            {
                _loop280: do {
                    if ((LA(1) == ID)) {
                        ...
                        Option newOp = new Option(op.getText(), rhs.getText(),
                                gr);
                        ...
                        if (gr != null && op.getText().equals("importVocab")) {
                            ...
                            gr.exportVocab = rhs.getText().substring(0,
                                    rhs.getText().length() - 1);
    ...
    public final Grammar class_def(String file, Hierarchy hier)
        ...
        try { // for error handling
            ...
            if (gr != null) {
                // antlr.Tool.toolError("redefinition of grammar
                // "+gr.getName()+" ignored");
                gr = null;
    ...
    public final String exceptionHandler() throws RecognitionException,
        ...
        try { // for error handling
            ...
            a2 = LT(1);
            match(ACTION);
            h = System.getProperty("line.separator") + "catch " + a1.getText()
                    + " " + a2.getText();
        } catch (RecognitionException ex) {
            reportError(ex);
            consume();
    ...
    public static final String[] _tokenNames = { "<0>", "EOF", "<2>",
            "NULL_TREE_LOOKAHEAD", "\"tokens\"", "HEADER_ACTION",
            "SUBRULE_BLOCK", "ACTION", "\"class\"", "ID", "\"extends\"",
            "SEMI", "TOKENS_SPEC", "OPTIONS_START", "ASSIGN_RHS", "RCURLY",
            "\"protected\"", "\"private\"", "\"public\"", "BANG", "ARG_ACTION",
            "\"returns\"", "RULE_BLOCK", "\"throws\"", "COMMA",
            "\"exception\"", "\"catch\"", "ALT", "ELEMENT", "LPAREN", "RPAREN",
            "ID_OR_KEYWORD", "CURLY_BLOCK_SCARF", "WS", "NEWLINE", "COMMENT",
            "SL_COMMENT", "ML_COMMENT", "CHAR_LITERAL", "STRING_LITERAL",
            "ESC", "DIGIT", "XDIGIT" };
