 ...
 *
 * $Id: Rule.java,v 1.1 2007-10-19 15:54:55 soto-r Exp $
 */
...
class Rule {
    ...
    /**
     * If 'rule' narrows the visible of 'this', return true; For example, 'this'
     * is public and 'rule' is private, true is returned. You cannot narrow the
     * vis. of a rule.
     */
    ...
    /**
     * Two rules have the same signature if they have: same name same return
     * value same args I do a simple string compare now, but later the type
     * could be pulled out so it is insensitive to names of args etc...
     */
