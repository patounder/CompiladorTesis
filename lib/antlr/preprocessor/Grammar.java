 ...
 *
 * $Id: Grammar.java,v 1.1 2007-10-19 15:54:55 soto-r Exp $
 */
...
class Grammar {
    ...
    /**
     * Copy all nonoverridden rules, vocabulary, and options into this grammar
     * from supergrammar chain. The change is made in place; e.g., this
     * grammar's vector of rules gets bigger. This has side-effects: all
     * grammars on path to root of hierarchy are expanded also.
     */
    public void expandInPlace() {
        ...
        // Expand super grammar first (unless it's a predefined or subgrammar of
        // predefined)
        ...
        if ((options != null && options.getElement("importVocab") == null)
            ...
            Option inputV = new Option("importVocab", superG.exportVocab + ";",
                    this);
            addOption(inputV);
            ...
            String newImportVocabFileName = antlrTool
                    .fileMinusPath(superExportVocabFileName);
            if (path.equals("." + System.getProperty("file.separator"))) {
                // don't copy tokdef file onto itself (must be current
                // directory)
                // System.out.println("importVocab file same dir; leaving as " +
    ...
    public void inherit(Option o, Grammar superG) {
        // do NOT inherit importVocab/exportVocab options under any
        // circumstances
        ...
        if (overriddenRule != null) {
            ...
            if (!overriddenRule.sameSignature(r)) {
                ...
                antlrTool.warning("rule " + getName() + "."
                        ...
                        + " has different signature than " + superG.getName()
                        + "." + overriddenRule.getName());
            }
    ...
    public void inherit(String memberAction, Grammar superG) {
        ...
        if (memberAction != null) { // don't have one here, use supergrammar's
            // action
    ...
    public String toString() {
        ...
        if (superClass != null) {
            ...
            // user must make sure that the superclass derives from super
            // grammar class
