 ...
 *
 * $Id: Tool.java,v 1.1 2007-10-19 15:54:55 soto-r Exp $
 */
...
public class Tool {
    ...
    public boolean preprocess() {
        ...
        String expandedFileName = gf
                .nameForExpandedGrammarFile(grammarFileName);
        ...
        if (expandedFileName.equals(grammarFileName)) {
            ...
            try {
                ...
                antlrTool.toolError("cannot write expanded grammar file "
                        + expandedFileName);
                return false;
            }
        }
    ...
    /**
     * Process -glib options and grammar file. Create a new args list that does
     * not contain the -glib option. The grammar file name might be modified
     * and, hence, is not added yet to args list.
     */
        ...
        for (int i = 0; i < incomingArgs.length; i++) {
            ...
            if (incomingArgs[i].equals("-glib")) {
                ...
                if (File.separator.equals("\\")
                    ...
                    grammars = antlrTool.parseSeparatedList(
                            incomingArgs[i + 1], ';');
                    i++;
                }
