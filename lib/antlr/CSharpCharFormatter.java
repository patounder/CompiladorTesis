 ...
 *
 * $Id: CSharpCharFormatter.java,v 1.1 2007-10-19 15:55:00 soto-r Exp $
 */
...
class CSharpCharFormatter implements CharFormatter {
    ...
    /**
     * Given a character value, return a string representing the character that
     * can be embedded inside a string literal or character literal This works
     * for Java/C/C++ code-generation and languages with compatible
     * special-character-escapment. Code-generators for languages should
     * override this method.
     * 
     * @param c
     *            The character of interest.
     * @param forCharLiteral
    ...
    /**
     * Converts a String into a representation that can be use as a literal when
     ...
     * literal that can be recognized by the target language compiler. This
     * works for languages that use single-quotes for character literals.
    ...
    /**
     * Converts a String into a string literal This works for languages that use
     * double-quotes for string literals. Code-generators for languages should
     * override this method.
     * 
     * @param s
     *            The String to be changed into a literal
