...
public class ANTLRParser extends antlr.LLkParser implements ANTLRTokenTypes {
    ...
    public ANTLRParser(TokenBuffer tokenBuf,
            ANTLRGrammarParseBehavior behavior_, Tool tool_) {
        super(tokenBuf, 1);
    ...
    public final void grammar() throws RecognitionException,
                ...
                _loop4: do {
                    if ((LA(1) == LITERAL_header)) {
                        if (inputState.guessing == 0) {
                            ...
                            n = null; // RK: prevent certain orders of header
                            // actions
    ...
    public final void fileOptionsSpec() throws RecognitionException,
            TokenStreamException {
        ...
        try { // for error handling
            ...
            if (inputState.guessing == 0) {
                ...
                if (ex instanceof NoViableAltException) {
                    ...
                    // RK: These probably generate inconsequent error
                    // messages...
    ...
    public final void lexerSpec(String doc) throws RecognitionException,
            TokenStreamException {
    ...
    public final void treeParserSpec(String doc) throws RecognitionException,
            TokenStreamException {
    ...
    public final void parserSpec(String doc) throws RecognitionException,
            TokenStreamException {
            ...
            case SEMI: {
                if (inputState.guessing == 0) {
                    ...
                    antlrTool.warning("use 'class X extends Parser'",
                            getFilename(), idTok.getLine(), idTok.getColumn());
    ...
    public final Token optionValue() throws RecognitionException,
            TokenStreamException {
        Token retval;
    ...
    public final void parserOptionsSpec() throws RecognitionException,
            TokenStreamException {
    ...
    public final void treeParserOptionsSpec() throws RecognitionException,
            TokenStreamException {
    ...
    public final void lexerOptionsSpec() throws RecognitionException,
            TokenStreamException {
    ...
    public final BitSet charSet() throws RecognitionException,
            TokenStreamException {
        BitSet b;
    ...
    public final void subruleOptionsSpec() throws RecognitionException,
            TokenStreamException {
    ...
    /**
     * Match a.b.c.d qualified ids; WILDCARD here is overloaded as id separator;
     * that is, I need a reference to the '.' token.
     */
    public final Token qualifiedID() throws RecognitionException,
            TokenStreamException {
        Token qidTok = null;
    ...
    public final BitSet setBlockElement() throws RecognitionException,
            TokenStreamException {
        BitSet b;
        ...
        }
        {
            ...
            case RANGE: {
                ...
                if (inputState.guessing == 0) {
                    ...
                    int rangeMax = ANTLRLexer.tokenTypeForCharLiteral(c2
                            .getText());
                    if (rangeMax < rangeMin) {
                        antlrTool.error("Malformed range line ", getFilename(),
                                c1.getLine(), c1.getColumn());
                    }
    ...
    public final void tokensSpecOptions(Token t) throws RecognitionException,
            TokenStreamException {
    ...
    public final void ruleOptionsSpec() throws RecognitionException,
            TokenStreamException {
            ...
            if ((LA(1) == TOKEN_REF || LA(1) == RULE_REF) && (LA(2) == ASSIGN)) {
                ...
                }
                {
                    ...
                    case RULE_REF: {
                        ...
                        if (inputState.guessing == 0) {
                            behavior
                                    .refRule(assignId, rr, label, args, autoGen);
                        }
                        break;
                    }
                    case TOKEN_REF: {
                        ...
                        if (inputState.guessing == 0) {
                            behavior.refToken(assignId, tr, label, args, false,
                                    autoGen, lastInRule());
                        }
                        break;
                    }
                ...
                }
                {
                    ...
                    case RULE_REF: {
                        ...
                        if (inputState.guessing == 0) {
                            behavior
                                    .refRule(assignId, r2, label, args, autoGen);
                        }
                        break;
                    }
                    case NOT_OP: {
                    ...
                    default:
                        if ((LA(1) == STRING_LITERAL || LA(1) == CHAR_LITERAL || LA(1) == TOKEN_REF)
                                && (LA(2) == RANGE)) {
                            range(label);
    ...
    public final void range(Token label) throws RecognitionException,
            TokenStreamException {
        ...
        case CHAR_LITERAL: {
            ...
            if (inputState.guessing == 0) {
                behavior.refCharRange(crLeft, crRight, label, autoGen,
                        lastInRule());
            }
            break;
        }
        ...
        case TOKEN_REF: {
            ...
            if (inputState.guessing == 0) {
                behavior.refTokenRange(trLeft, trRight, label, autoGen,
                        lastInRule());
            }
            break;
        }
    ...
    public final void terminal(Token label) throws RecognitionException,
            TokenStreamException {
        ...
        case CHAR_LITERAL: {
            ...
            if (inputState.guessing == 0) {
                behavior
                        .refCharLiteral(cl, label, false, autoGen, lastInRule());
            }
            break;
        }
        case TOKEN_REF: {
            ...
            if (inputState.guessing == 0) {
                behavior.refToken(null, tr, label, args, false, autoGen,
                        lastInRule());
            }
            break;
        }
    ...
    public final void notTerminal(Token label) throws RecognitionException,
            TokenStreamException {
        ...
        case TOKEN_REF: {
            ...
            autoGen = ast_type_spec();
            if (inputState.guessing == 0) {
                behavior.refToken(null, tr, label, null, true, autoGen,
                        lastInRule());
            }
            break;
        }
    ...
    public final int ast_type_spec() throws RecognitionException,
            TokenStreamException {
        int autoGen;
    ...
    public static final String[] _tokenNames = { "<0>", "EOF", "<2>",
            "NULL_TREE_LOOKAHEAD", "\"tokens\"", "\"header\"",
            "STRING_LITERAL", "ACTION", "DOC_COMMENT", "\"lexclass\"",
            "\"class\"", "\"extends\"", "\"Lexer\"", "\"TreeParser\"",
            "OPTIONS", "ASSIGN", "SEMI", "RCURLY", "\"charVocabulary\"",
            "CHAR_LITERAL", "INT", "OR", "RANGE", "TOKENS", "TOKEN_REF",
            "OPEN_ELEMENT_OPTION", "CLOSE_ELEMENT_OPTION", "LPAREN", "RPAREN",
            "\"Parser\"", "\"protected\"", "\"public\"", "\"private\"", "BANG",
            "ARG_ACTION", "\"returns\"", "COLON", "\"throws\"", "COMMA",
            "\"exception\"", "\"catch\"", "RULE_REF", "NOT_OP", "SEMPRED",
            "TREE_BEGIN", "QUESTION", "STAR", "PLUS", "IMPLIES", "CARET",
            "WILDCARD", "\"options\"", "WS", "COMMENT", "SL_COMMENT",
            "ML_COMMENT", "ESC", "DIGIT", "XDIGIT", "NESTED_ARG_ACTION",
            "NESTED_ACTION", "WS_LOOP", "INTERNAL_RULE_REF", "WS_OPT" };
