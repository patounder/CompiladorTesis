 ...
 *
 * $Id: SimpleTokenManager.java,v 1.1 2007-10-19 15:54:59 soto-r Exp $
 */
...
class SimpleTokenManager implements TokenManager, Cloneable {
    ...
    SimpleTokenManager(String name_, Tool tool_) {
        antlrTool = tool_;
        name = name_;
        // Don't make a bigger vector than we need, because it will show up in
        // output sets.
        ...
        vocabulary.setElementAt("NULL_TREE_LOOKAHEAD",
