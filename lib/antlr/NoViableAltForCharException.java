 ...
 *
 * $Id: NoViableAltForCharException.java,v 1.1 2007-10-19 15:55:01 soto-r Exp $
 */
...
public class NoViableAltForCharException extends RecognitionException {
    ...
    public NoViableAltForCharException(char c, CharScanner scanner) {
        super("NoViableAlt", scanner.getFilename(), scanner.getLine(), scanner
                .getColumn());
        foundChar = c;
    }
     ...
     *             {@see #NoViableAltForCharException(char, String, int, int) }
     */
