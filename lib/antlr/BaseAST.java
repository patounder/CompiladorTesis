 ...
 *
 * $Id: BaseAST.java,v 1.1 2007-10-19 15:54:57 soto-r Exp $
 */
 ...
 * 
 * These trees are particular useful for translators because of the flexibility
 * of the children lists. They are also very easy to walk automatically, whereas
 * trees with specific children reference fields can't easily be walked
 * automatically.
 * 
 * This class contains the basic support for an AST. Most people will create
...
public abstract class BaseAST implements AST, Serializable {
    ...
    private void doWorkForFindAll(Vector v, AST target, boolean partialMatch) {
        ...
        siblingWalk: for (sibling = this; sibling != null; sibling = sibling
                .getNextSibling()) {
    ...
    /**
     * Is 'sub' a subtree of this list? The siblings of the root are NOT
     * ignored.
     */
    public boolean equalsListPartial(AST sub) {
        ...
        // Otherwise, start walking sibling lists. First mismatch, return false.
        for (sibling = this; sibling != null && sub != null; sibling = sibling
                .getNextSibling(), sub = sub.getNextSibling()) {
            // as a quick optimization, check roots first.
    ...
    /**
     * Is 't' a subtree of the tree rooted at 'this'? The siblings of 'this' are
     * ignored.
     */
    ...
    /**
     * Walk the tree looking for all exact subtree matches. Return an
     * ASTEnumerator that lets the caller walk the list of subtree roots found
     * herein.
     */
    ...
    /**
     * Walk the tree looking for all subtrees. Return an ASTEnumerator that lets
     * the caller walk the list of subtree roots found herein.
     */
