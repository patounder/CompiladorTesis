 ...
 *
 * $Id: InputBuffer.java,v 1.1 2007-10-19 15:54:56 soto-r Exp $
 */
 ...
 * <p>
 * A dynamic array is used to buffer up all the input characters. Normally, "k"
 * characters are stored in the buffer. More characters may be stored during
...
public abstract class InputBuffer {
     ...
     * matched since the most recent mark() is no longer held by the buffer. So,
     * you either do a mark/rewind for failed predicate or mark/commit to keep
     * on parsing without rewinding the input.
     */
    public void commit() {
        nMarkers--;
    }
    ...
    /**
     * Return an integer marker that can be used to rewind the buffer to its
     * current state.
     */
    public int mark() {
        syncConsume();
