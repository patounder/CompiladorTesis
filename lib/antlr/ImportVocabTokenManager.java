 ...
 *
 * $Id: ImportVocabTokenManager.java,v 1.1 2007-10-19 15:54:58 soto-r Exp $
 */
...
class ImportVocabTokenManager extends SimpleTokenManager implements Cloneable {
    ...
    // also searched.
    ImportVocabTokenManager(Grammar grammar, String filename_, String name_,
            Tool tool_) {
        // initialize
        super(name_, tool_);
        ...
        try {
            ...
            antlrTool
                    .panic("Error reading importVocab file '" + filename + "'");
        }
    }
    ...
    public void define(String s, int ttype) {
        ...
        super.define(ts);
        maxToken = (ttype + 1) > maxToken ? (ttype + 1) : maxToken; // record
        // maximum
        // token
        // type
    }
