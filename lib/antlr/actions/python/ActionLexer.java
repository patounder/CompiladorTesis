 ...
 * 
 * AST related translations ## -> currentRule_AST #(x,y,z) ->
 * codeGenerator.getASTCreateString(vector-of(x,y,z)) #[x] ->
 * codeGenerator.getASTCreateString(x) #x -> codeGenerator.mapTreeId(x)
 * 
 * Inside context of #(...), you can ref (x,y,z), [x], and x as shortcuts.
 * 
 * Text related translations
 * 
 * $append(x) -> self.text.append(x) $setText(x) -> self.text.setLength(_begin)
 * self.text.append(x) $getText -> self.text.getString(_begin) $setToken(x) ->
 * _token = x $setType(x) -> _ttype = x $FOLLOW(r) -> FOLLOW set name for rule r
 * (optional arg) $FIRST(r) -> FIRST set name for rule r (optional arg)
 * 
 * experimental: $newline, $nl -> self.newline() $skip -> _ttype = SKIP
 */
public class ActionLexer extends antlr.CharScanner implements
    ...
    public ActionLexer(String s, RuleBlock currentRule,
            CodeGenerator generator, ActionTransInfo transInfo) {
    ...
    public void reportError(RecognitionException e) {
        antlrTool.error("Syntax error in action: " + e, getFilename(),
                getLine(), getColumn());
    }
        ...
        if ((LA(1) == '$') && (LA(2) == 's') && (LA(3) == 'e')) {
            match("$set");
            {
                if ((LA(1) == 'T') && (LA(2) == 'e')) {
                    ...
                    String t;
                    t = "self.text.setLength(_begin) ; self.text.append("
                            + a2.getText() + ")";
                    text.setLength(_begin);
                    text.append(t);
            ...
            text.setLength(_begin);
            text.append("self.text.getString(_begin)");
    ...
    protected final void mID(boolean _createToken) throws RecognitionException,
    ...
    protected final void mWS(boolean _createToken) throws RecognitionException,
            CharStreamException, TokenStreamException {
        int _ttype;
        Token _token = null;
        int _begin = text.length();
    ...
    protected final void mAST_CONSTRUCTOR(boolean _createToken)
        ...
        {
            if ((LA(1) == ',') && (_tokenSet_10.member(LA(2)))
                    && ((LA(3) >= '\u0003' && LA(3) <= '\u00ff'))) {
                _saveIndex = text.length();
                match(',');
                text.setLength(_saveIndex);
        ...
        text.setLength(_begin);
        text.append(generator.getASTCreateString(null, args));
    ...
    protected final void mML_COMMENT(boolean _createToken)
        ...
        /*
         * force a newline (MK: should actually be the same newline as was
         * matched earlier in the block comment
         */
        text.append("\n");
