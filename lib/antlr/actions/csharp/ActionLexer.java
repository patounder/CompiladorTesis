 ...
 * text.append(x) $getText -> new
 * String(text.getBuffer(),_begin,text.length()-_begin) $setToken(x) -> _token =
 * x $setType(x) -> _ttype = x $FOLLOW(r) -> FOLLOW set name for rule r
...
public class ActionLexer extends antlr.CharScanner implements
    ...
    protected final void mTEXT_ITEM(boolean _createToken)
        ...
        if ((LA(1) == '$') && (LA(2) == 'F') && (LA(3) == 'O')) {
            ...
            text.setLength(_begin);
            text.append("text.ToString(_begin, text.Length-_begin)");
    ...
    protected final void mTREE(boolean _createToken)
        ...
        terms.appendElement(generator.processStringForASTConstructor(t
                .getText()));
        ...
        }
        {
            _loop649: do {
                if ((LA(1) == ',')) {
                    ...
                    terms.appendElement(generator
                            .processStringForASTConstructor(t2.getText()));
