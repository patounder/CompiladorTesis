 ...
 *
 * $Id: MismatchedCharException.java,v 1.1 2007-10-19 15:55:01 soto-r Exp $
 */
...
public class MismatchedCharException extends RecognitionException {
    ...
    public MismatchedCharException(char c, char lower, char upper_,
            boolean matchNot, CharScanner scanner_) {
        super("Mismatched char", scanner_.getFilename(), scanner_.getLine(),
                scanner_.getColumn());
    ...
    public MismatchedCharException(char c, char expecting_, boolean matchNot,
    ...
    public MismatchedCharException(char c, BitSet set_, boolean matchNot,
            CharScanner scanner_) {
        super("Mismatched char", scanner_.getFilename(), scanner_.getLine(),
                scanner_.getColumn());
